...
export function WhatsAppConfig() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      // Existing config without a new access_token — the server will
      // decrypt the stored token and reuse it.
            ...
            <Accordion>
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    <li>{t('step3_1')}</li>
                    <li>{t.rich('step3_2', { bold: (chunks) => <strong className="text-foreground">{chunks}</strong> })}</li>
                    <li>{t.rich('step3_3', { bold: (chunks) => <strong className="text-foreground">{chunks}</strong> })}</li>
                    <li>{t.rich('step3_4', { bold: (chunks) => <strong className="text-foreground">{chunks}</strong> })}</li>
                  </ol>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    <li>{t('step4_1')}</li>
                    <li>{t('step4_2')}</li>
                    <li>{t.rich('step4_3', { bold: (chunks) => <strong className="text-foreground">{chunks}</strong> })}</li>
                    <li>{t.rich('step4_4', { bold: (chunks) => <strong className="text-foreground">{chunks}</strong> })}</li>
                    <li>{t('step4_5')}</li>
                  </ol>
                </AccordionContent>
              </AccordionItem>
